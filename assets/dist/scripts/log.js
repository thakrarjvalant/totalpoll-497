...
(function (TotalPoll) {
    ...
    var RepositoryService = /** @class */ (function () {
        ...
        RepositoryService.prototype.purge = function () {
            return this.resource.purge({
                action: this.prefix + "_log_purge",
                poll: this.pollId
            }).$promise;
        };
    ...
    var LogBrowserComponent = /** @class */ (function (_super) {
        ...
        LogBrowserComponent.prototype.exportAs = function (format) {
            ...
            this.RepositoryService.getExport(format, this.filters)
                ...
                setTimeout(function () {
                    document.querySelector('.totalpoll-log-browser-exports')
